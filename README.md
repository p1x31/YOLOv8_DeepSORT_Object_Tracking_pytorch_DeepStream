...
```
"https://drive.google.com/uc?id=1rjBn8Fl1E_9d0EMVtL24S9aNQOJAveR5&confirm=t"
```

- Run the code with mentioned command below.

- For yolov8 object detection + Tracking webcam
```
python predict.py model=yolov8x.pt source="0" show=True
```
...
- For yolov8 object detection + Tracking + Vehicle Counting
```
python predict_cnt.py model=yolov8l.pt source="test3.mp4" show=True
```
